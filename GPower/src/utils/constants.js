...
export const SERVICES = [
  { id: 1, title: "Bike Component Manufacturing", desc: "High-performance parts for racing and recreational bicycles including frames, wheels, and drivetrain components." },
  { id: 2, title: "Automotive Precision Parts", desc: "Custom engine components, suspension parts, and body panels for luxury and performance vehicles." },
  { id: 3, title: "Rapid Prototyping", desc: "Quick turnaround on prototypes using advanced 3D printing and CNC machining technologies." },
