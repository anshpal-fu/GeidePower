...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Services Section */}
      <motion.section
        className="py-12 md:py-20 bg-[var(--color-accent)]"
        initial={{ opacity: 0 }}
      ...
      >
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="text-center mt-8 md:mt-12">
            <motion.a
              href="/services"
              className="btn-secondary px-6 md:px-8 py-2 md:py-3 inline-block"
      ...
      {/* Featured Products */}
      <motion.section
        className="py-12 md:py-20 bg-[var(--color-light)]"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
      ...
      {/* Stats Section */}
      <motion.section
        className="py-12 md:py-20 bg-gradient-to-r from-[var(--color-primary)] to-[#002a52] text-white"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 text-center">
            {[
              ...
              { value: "98%", label: "Client Satisfaction", delay: 0.3 },
              { value: "24/7", label: "Support Available", delay: 0.4 },
              { value: "15+", label: "Years Experience", delay: 0.5 },
            ].map((stat, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                <motion.div
                  className="text-4xl md:text-5xl font-bold text-[var(--color-secondary)] mb-2"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  viewport={{ once: true }}
      ...
      <motion.section
        className="py-12 md:py-20 bg-gradient-to-b from-[#FFFDF5] to-[#FFF4CC]"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
            ...
            {[
              {
                ...
                answer:
                  "We specialize in a wide range of materials including aluminum alloys, steel, titanium, carbon fiber, and specialized composites."
              },
              {
                id: 2,
                question: "What is your typical turnaround time?",
                answer:
                  "Simple prototypes can be completed in 2-3 weeks, while larger production runs typically take 4-6 weeks."
              },
              {
                id: 3,
                question: "Do you offer design assistance?",
                answer:
                  "Absolutely! Our engineering team provides comprehensive design support, from initial concept development to final production-ready designs."
              },
              {
                id: 4,
                question: "Do you ship internationally?",
                answer:
                  "Yes, we ship worldwide with reliable logistics partners. We handle all export documentation and customs requirements."
              }
            ].map((faq, index) => (
              <motion.div
                key={faq.id}
              ...
              >
                <div className="w-full px-4 sm:px-6 py-4 sm:py-5 text-left flex justify-between items-center bg-white">
                  <h3 className="text-base sm:text-lg font-bold text-[var(--color-dark)]">
                    {faq.question}
                  </h3>
                </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="text-base md:text-xl text-gray-300 max-w-2xl md:max-w-3xl mx-auto mb-6 md:mb-10"
            >
            ...
            >
              <motion.a
                href="/contact"
                className="btn-accent inline-block px-4 md:px-6 py-2 md:py-3"
            ...
            {[
              ...
              >
                <div className="flex items-center gap-4 mb-4 md:mb-6">
                  <div className="w-12 md:w-16 h-12 md:h-16 rounded-full bg-gray-200 flex items-center justify-center">
                ...
                <p className="text-gray-700 text-sm md:text-lg italic">"{testimonial.quote}"</p>
                <div className="flex text-[var(--color-secondary)] mt-2 md:mt-4">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} xmlns="http://www.w3.org/2000/svg" className="h-4 md:h-5 w-4 md:w-5" viewBox="0 0 20 20" fill="currentColor">
