  ...
  return (
    <div className="text-center">
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 top-20 bottom-20 w-1 bg-[var(--color-primary)] transform -translate-x-1/2 hidden md:block"></div>
          ...
          {steps.map((step, index) => (
            <motion.div
              ...
              className={`relative pl-10 md:pl-0 ${
                index % 2 === 0 ? "md:text-right md:pr-16 md:col-start-1" : "md:text-left md:pl-16 md:col-start-2"
              }`}
            ...
            >
              ...
              <motion.div
                className={`
                  ...
                  w-12 h-12 rounded-full bg-[var(--color-primary)] text-white
                  flex items-center justify-center font-bold text-xl z-10
